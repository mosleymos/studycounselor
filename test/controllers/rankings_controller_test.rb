...
class RankingsControllerTest < ActionController::TestCase
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post :create, ranking: { comment: @ranking.comment, counselor_id: @ranking.counselor_id, grade: @ranking.grade, student_id: @ranking.student_id }
    end
  ...
  test "should update ranking" do
    patch :update, id: @ranking, ranking: { comment: @ranking.comment, counselor_id: @ranking.counselor_id, grade: @ranking.grade, student_id: @ranking.student_id }
    assert_redirected_to ranking_path(assigns(:ranking))
  end
